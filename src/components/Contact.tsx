              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-accent/50 hover:bg-accent transition-colors cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-sage-green hover:text-primary transition-colors cursor-pointer">sarah.chen@ucsf.edu</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-accent/50 hover:bg-accent transition-colors cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-sage-green hover:text-primary transition-colors cursor-pointer">(415) 555-0123</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg bg-accent/50 hover:bg-accent transition-colors cursor-pointer">
